            ...
            <Box px={4} bg={useColorModeValue('rgba(0,0,0,0.5)', '')} color={useColorModeValue('gray.50', '')} >
                <Flex  h={16} alignItems={'center'} justifyContent={'space-between'}>
                    ...
                    <HStack spacing={8} display={{ base: 'none', md: 'flex' }}>
                        ...
                        <Box px={3} py={1} rounded={'lg'} _hover={{ textDecoration: 'none', bg: useColorModeValue('gray.50', ''), color: useColorModeValue('gray.900', '') }}><Link as={NextLink} _hover={{ textDecoration: 'none' }} href='#massages'><h1 className='font-bebas text-xl tracking-widest'>Massage</h1></Link></Box>
                    </HStack>
                    <IconButton
